// This file is based on Isaac Abraham's source at
// https://github.com/isaacabraham/azure-fsharp-helpers/blob/master/src/configuration.fs.

module private Bugfree.Spo.Analytics.Cli.AzureConfiguration
...
let applyAzureEnvironmentToConfigurationManager =
    getEnvironmentSettings >> applyToConfigurationManager